    ...
    <AuthGuardContainer>
      <div className="flex h-screen overflow-hidden bg-[#F6F6F6]">
        ...
        <div className="flex-1 flex flex-col overflow-hidden pr-4 pb-4">
          ...
          <div className="flex-1 flex flex-col overflow-hidden rounded-xl bg-white dark:bg-[#171717]">
            <div className="py-7 px-8 flex-1 min-h-0 flex flex-col relative overflow-y-auto">
