          ...
          <div className="flex items-center justify-between w-full bg-setting rounded-xl p-3 px-4">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col space-y-1">
                <Label>主机配置</Label>
                <span className="text-muted-foreground">配置不同远程主机的系统类型偏好</span>
              </div>
            </div>
                ...
                <div className="grid gap-3">
                  ...
                  <div className="grid gap-2">
                    ...
                    <NativeSelect
                      ...
                      onChange={(e) => setNewSystemFamily(e.target.value as 'debian' | 'red_hat')}
                    >
                      <NativeSelectOption value="debian">Debian 系</NativeSelectOption>
                      <NativeSelectOption value="red_hat">Red Hat 系</NativeSelectOption>
                    </NativeSelect>
                  </div>
                  <Button onClick={handleAddHostSystem} disabled={!newHostname.trim() || bindTerminalMutation.isPending}>
                  ...
                  {terminalsData.items.map((terminal, idx) => (
                    <div key={terminal.id}>
                      <div className="p-3 flex justify-between items-center hover:bg-accent/50 transition-colors">
                        ...
                        {terminal.linux_distro === 'debian' ? 'Debian 系' : 'Red Hat 系'}
                      </span>
                        </div>
